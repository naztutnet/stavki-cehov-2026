...
function topbar(route) {
  ...
  return `<header class="topbar"><button class="menu" id="menu">☰</button><div class="breadcrumb">KinoRates <span>/</span> ${label}</div><div class="top-actions"><button class="quiet" data-feedback data-feedback-topic="Хочу поделиться актуальной ставкой">Поделиться ставкой</button></div></header>`;
}
