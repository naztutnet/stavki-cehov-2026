window.KINORATES_UPDATES = [
  {
    ...
    text: "База расширена до 424 позиций. Ставки, подтверждённые опубликованными письмами 2023–2026 годов, отделены от позиций без подтверждающего первоисточника и от документов, которые ещё требуют построчной сверки. Обновлены ставки скрипт-супервайзеров и ассистентов по актёрам, добавлены четыре позиции."
  },
  {
    date: "2026-08-11",
